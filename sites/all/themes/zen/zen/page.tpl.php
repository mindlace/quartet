<?php
// $Id: page.tpl.php,v 1.17 2008/12/15 13:32:59 johnalbin Exp $
    ...
    <div id="header"><div id="header-inner" class="clear-block">
      ...
      <?php if ($logo or $site_name or $site_slogan): ?>
        <div id="logo-title">
          ...
          <?php if ($logo): ?>
            <div id="logo"><a href="<?php print $base_path; ?>node" title="<?php print t('Home'); ?>" rel="home"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" id="logo-image" /></a></div>
          <?php endif; ?>
