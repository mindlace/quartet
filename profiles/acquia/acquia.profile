...
function acquia_form_alter(&$form, $form_state, $form_id) {
  if ($form_id == 'install_configure') {
    ...
    $form['site_information']['acquia_identifier'] = array(
      ...
      '#description' => t('Please provide your Acquia Network subscription identifier for this installation here. You can set it later in Administer > Site configuration > Acquia settings.'),
      '#type' => 'textfield',
      '#required' => FALSE,
    );
    $form['site_information']['acquia_key'] = array(
      '#title' => t('Acquia subscription key'),
      '#description' => t('Please provide your Acquia Network subscription key for this installation here.  You can set it later in Administer > Site configuration > Acquia settings.'),
      '#type' => 'textfield',
      '#required' => FALSE,
    );
